    ...
    <>
      <div className="info">
          ...
          <div className="info" style={{ marginTop: 30 }}>
            ...
            No entanto, essa evolução também trouxe à tona desafios complexos relacionados à representação, discriminação e inclusão de diferentes grupos             étnico-raciais na esfera digital. A era digital prometia ser um espaço democrático e inclusivo, onde as barreiras físicas e geográficas seriam superadas,             permitindo que vozes marginalizadas encontrassem visibilidade e expressão. Todavia, as desigualdades que existem na sociedade offline rapidamente se            manifestaram online. As plataformas digitais muitas vezes reproduzem e ampliam estereótipos, preconceitos e discriminações presentes na sociedade,            refletindo-se em discursos de ódio, racismo estrutural e exclusão virtual. 

            A falta de representatividade é uma das questões centrais nesse contexto. Muitas ve
            </p>
